 ...
 * @module model/ExpireUserSessionRequest
 * @version 1.0.0
 */
export class ExpireUserSessionRequest {
  /**
   * Constructs a new <code>ExpireUserSessionRequest</code>.
   * @alias module:model/ExpireUserSessionRequest
   * @class
   * @param data {module:model/ExpireUserSessionRequestData} 
   * @param signature {String} This signature can be obtained by getting the content from the `data` then generate a `HMAC SHA256 Base64` encoded data. Please check the [Signature](#section/Signature) section.
   */
  ...
  /**
   * Constructs a <code>ExpireUserSessionRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ExpireUserSessionRequest} obj Optional instance to populate.
   * @return {module:model/ExpireUserSessionRequest} The populated <code>ExpireUserSessionRequest</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new ExpireUserSessionRequest();
      if (data.hasOwnProperty('data'))
        obj.data = ExpireUserSessionRequestData.constructFromObject(data['data']);
...
/**
 * @member {module:model/ExpireUserSessionRequestData} data
 */
ExpireUserSessionRequest.prototype.data = undefined;
 ...
 */
ExpireUserSessionRequest.prototype.signature = undefined;
