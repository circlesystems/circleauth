...
/**
 * The GetUserSessionResponseData model module.
 * @module model/GetUserSessionResponseData
 * @version 1.0.0
 */
export class GetUserSessionResponseData {
  /**
   * Constructs a new <code>GetUserSessionResponseData</code>.
   * @alias module:model/GetUserSessionResponseData
   * @class
   * @param sessionID {String} 
   * @param userID {String} 
   * @param startAt {Number} Unixtime in milliseconds
   * @param status {module:model/GetUserSessionResponseData.StatusEnum} `usedOnce` will return only for the first [Factor Authentication](#section/Factor-Authentication), after that the session will automatically expire. 
   */
  constructor(sessionID, userID, startAt, status) {
  ...
  /**
   * Constructs a <code>GetUserSessionResponseData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetUserSessionResponseData} obj Optional instance to populate.
   * @return {module:model/GetUserSessionResponseData} The populated <code>GetUserSessionResponseData</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new GetUserSessionResponseData();
 ...
 */
GetUserSessionResponseData.prototype.sessionID = undefined;

/**
 * @member {String} userID
 */
GetUserSessionResponseData.prototype.userID = undefined;

/**
 * Unixtime in milliseconds
 * @member {Number} startAt
 */
GetUserSessionResponseData.prototype.startAt = undefined;
 ...
 * @readonly
 */
GetUserSessionResponseData.StatusEnum = {
  /**
   * value: "active"
   * @const
   */
 ...
 * @member {module:model/GetUserSessionResponseData.StatusEnum} status
 */
GetUserSessionResponseData.prototype.status = undefined;

/**
 * Unixtime in milliseconds. Only sent when the `status` value is `expired`.
 * @member {Number} expiredAt
 */
GetUserSessionResponseData.prototype.expiredAt = undefined;
