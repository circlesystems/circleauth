...
/**
 * The Model2FAResponseData model module.
 * @module model/Model2FAResponseData
 * @version 1.0.0
 */
export class Model2FAResponseData {
  /**
   * Constructs a new <code>Model2FAResponseData</code>.
   * @alias module:model/Model2FAResponseData
   * @class
   * @param factorUrl {String} The URL that will open Circle Auth website or the app to request the user acceptance. Check [Factor Authentication](#section/FactorAuthentication)). acceptance.
   ...
   */
  constructor(factorUrl, customID, returnUrl) {
    this.factorUrl = factorUrl;
    this.customID = customID;
    this.returnUrl = returnUrl;
  }

  /**
   * Constructs a <code>Model2FAResponseData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Model2FAResponseData} obj Optional instance to populate.
   * @return {module:model/Model2FAResponseData} The populated <code>Model2FAResponseData</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new Model2FAResponseData();
      if (data.hasOwnProperty('factorUrl'))
        obj.factorUrl = ApiClient.convertToType(data['factorUrl'], 'String');
...
/**
 * The URL that will open Circle Auth website or the app to request the user acceptance. Check [Factor Authentication](#section/FactorAuthentication)). acceptance.
 * @member {String} factorUrl
 */
Model2FAResponseData.prototype.factorUrl = undefined;

/**
 * The customID parameter can be anything to track back to your system. Example: `session-123`
 * @member {String} customID
 */
Model2FAResponseData.prototype.customID = undefined;

/**
 * The return URL that will be used for redirection when the 2FA is accepted.
 * @member {String} returnUrl
 */
Model2FAResponseData.prototype.returnUrl = undefined;
 ...
 */
Model2FAResponseData.prototype.webhookUrl = undefined;
 ...
 * @member {String} phone
 */
Model2FAResponseData.prototype.phone = undefined;
 ...
 * @member {String} email
 */
Model2FAResponseData.prototype.email = undefined;

/**
 * This is the question you will make to the user. Example: `Confirm 1 BTC withdrawal?`
 * @member {String} question
 */
Model2FAResponseData.prototype.question = undefined;
 ...
 */
Model2FAResponseData.prototype.userID = undefined;
 ...
 */
Model2FAResponseData.prototype.mobileReturnUrl = undefined;
