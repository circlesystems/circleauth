...
import {ExpireUserSessionResponseData} from './ExpireUserSessionResponseData.js';

/**
 * The ExpireUserSessionResponse model module.
 * @module model/ExpireUserSessionResponse
 * @version 1.0.0
 */
export class ExpireUserSessionResponse {
  /**
   * Constructs a new <code>ExpireUserSessionResponse</code>.
   * @alias module:model/ExpireUserSessionResponse
   * @class
   * @param data {module:model/ExpireUserSessionResponseData} 
  ...
  /**
   * Constructs a <code>ExpireUserSessionResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ExpireUserSessionResponse} obj Optional instance to populate.
   * @return {module:model/ExpireUserSessionResponse} The populated <code>ExpireUserSessionResponse</code> instance.
   */
...
/**
 * @member {module:model/ExpireUserSessionResponseData} data
 */
ExpireUserSessionResponse.prototype.data = undefined;
 ...
 */
ExpireUserSessionResponse.prototype.signature = undefined;
