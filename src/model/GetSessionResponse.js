...
import {GetSessionResponseData} from './GetSessionResponseData';
...
export class GetSessionResponse {
   ...
   * @class
   * @param data {module:model/GetSessionResponseData} 
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = GetSessionResponseData.constructFromObject(data['data']);
...
/**
 * @member {module:model/GetSessionResponseData} data
 */
GetSessionResponse.prototype.data = undefined;
 ...
 */
GetSessionResponse.prototype.signature = undefined;
