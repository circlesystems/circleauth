...
/**
 * The ExpireUserSessionRequestData model module.
 * @module model/ExpireUserSessionRequestData
 * @version 1.0.0
 */
export class ExpireUserSessionRequestData {
  /**
   * Constructs a new <code>ExpireUserSessionRequestData</code>.
   * @alias module:model/ExpireUserSessionRequestData
   * @class
   * @param sessionID {String} `sessionID` to expire. This information comes from the [Login Authentication Return](#section/Login-Authentication) and [Factor Authentication Return](#section/Factor-Authentication).
   * @param userID {String} `userID` that is using the `sessionID`. This information comes from the [Login Authentication Return](#section/Login-Authentication) and [Factor Authentication Return](#section/Factor-Authentication).
   */
  ...
  /**
   * Constructs a <code>ExpireUserSessionRequestData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ExpireUserSessionRequestData} obj Optional instance to populate.
   * @return {module:model/ExpireUserSessionRequestData} The populated <code>ExpireUserSessionRequestData</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new ExpireUserSessionRequestData();
 ...
 */
ExpireUserSessionRequestData.prototype.sessionID = undefined;
 ...
 */
ExpireUserSessionRequestData.prototype.userID = undefined;
