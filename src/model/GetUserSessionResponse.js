 ...
 * @module model/GetUserSessionResponse
 * @version 1.0.0
 */
export class GetUserSessionResponse {
  /**
   * Constructs a new <code>GetUserSessionResponse</code>.
   * @alias module:model/GetUserSessionResponse
   * @class
   * @param data {module:model/GetUserSessionResponseData} 
  ...
  /**
   * Constructs a <code>GetUserSessionResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetUserSessionResponse} obj Optional instance to populate.
   * @return {module:model/GetUserSessionResponse} The populated <code>GetUserSessionResponse</code> instance.
   */
...
/**
 * @member {module:model/GetUserSessionResponseData} data
 */
GetUserSessionResponse.prototype.data = undefined;
 ...
 */
GetUserSessionResponse.prototype.signature = undefined;
