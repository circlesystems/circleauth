 ...
 * @module model/Create2FARequest
 * @version 1.0.0
 */
export class Create2FARequest {
  /**
   * Constructs a new <code>Create2FARequest</code>.
   * @alias module:model/Create2FARequest
   * @class
   * @param data {module:model/Model2FARequestData} 
  ...
  /**
   * Constructs a <code>Create2FARequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Create2FARequest} obj Optional instance to populate.
   * @return {module:model/Create2FARequest} The populated <code>Create2FARequest</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new Create2FARequest();
      if (data.hasOwnProperty('data'))
        obj.data = Model2FARequestData.constructFromObject(data['data']);
...
/**
 * @member {module:model/Model2FARequestData} data
 */
Create2FARequest.prototype.data = undefined;
 ...
 */
Create2FARequest.prototype.signature = undefined;
