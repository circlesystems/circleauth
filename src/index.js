...
import {ExpireUserSessionRequestData} from './model/ExpireUserSessionRequestData';
import {ExpireUserSessionResponse} from './model/ExpireUserSessionResponse';
import {ExpireUserSessionResponseData} from './model/ExpireUserSessionResponseData';
import {GetSessionResponse} from './model/GetSessionResponse';
import {GetSessionResponseData} from './model/GetSessionResponseData';
import {GetUserSessionResponse} from './model/GetUserSessionResponse';
import {GetUserSessionResponseData} from './model/GetUserSessionResponseData';
import {Model2FARequestData} from './model/Model2FARequestData';
import {Model2FAResponseData} from './model/Model2FAResponseData';
import {ResponseError} from './model/ResponseError';
import {UnicAuthApi} from './api/UnicAuthApi';
...
* <pre>
* var Unicauth = require('index'); // See note below*.
* var xxxSvc = new Unicauth.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new Unicauth.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new Unicauth.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new Unicauth.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
...
export {
    ...
    /**
    * The UnicAuthApi service constructor.
    * @property {module:api/UnicAuthApi}
    */
    UnicAuthApi
};
