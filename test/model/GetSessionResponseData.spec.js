...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetSessionResponseData', function() {
      beforeEach(function() {
        instance = new CircleAuth.GetSessionResponseData();
      });

      it('should create an instance of GetSessionResponseData', function() {
        // TODO: update the code to test GetSessionResponseData
        expect(instance).to.be.a(CircleAuth.GetSessionResponseData);
      });
      ...
      it('should have the property miliUnixtime (base name: "miliUnixtime")', function() {
        // TODO: update the code to test the property miliUnixtime
        expect(instance).to.have.property('miliUnixtime');
        // expect(instance.miliUnixtime).to.be(expectedValueLiteral);
      });
