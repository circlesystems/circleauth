...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetUserSessionResponseData', function() {
      beforeEach(function() {
        instance = new CircleAuth.GetUserSessionResponseData();
      });

      it('should create an instance of GetUserSessionResponseData', function() {
        // TODO: update the code to test GetUserSessionResponseData
        expect(instance).to.be.a(CircleAuth.GetUserSessionResponseData);
      });
