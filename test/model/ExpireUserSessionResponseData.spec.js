...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ExpireUserSessionResponseData', function() {
      beforeEach(function() {
        instance = new CircleAuth.ExpireUserSessionResponseData();
      });

      it('should create an instance of ExpireUserSessionResponseData', function() {
        // TODO: update the code to test ExpireUserSessionResponseData
        expect(instance).to.be.a(CircleAuth.ExpireUserSessionResponseData);
      });
