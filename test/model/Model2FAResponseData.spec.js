...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Model2FAResponseData', function() {
      beforeEach(function() {
        instance = new CircleAuth.Model2FAResponseData();
      });

      it('should create an instance of Model2FAResponseData', function() {
        // TODO: update the code to test Model2FAResponseData
        expect(instance).to.be.a(CircleAuth.Model2FAResponseData);
      });

      it('should have the property factorUrl (base name: "factorUrl")', function() {
        // TODO: update the code to test the property factorUrl
        expect(instance).to.have.property('factorUrl');
        // expect(instance.factorUrl).to.be(expectedValueLiteral);
      });
