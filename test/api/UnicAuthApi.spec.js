...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.Unicauth);
  }
}(this, function(expect, Unicauth) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new Unicauth.UnicAuthApi();
  });

  describe('(package)', function() {
    describe('UnicAuthApi', function() {
      describe('create2FA', function() {
        it('should call create2FA successfully', function(done) {
          // TODO: uncomment, update parameter values for create2FA call and complete the assertions
          /*

          instance.create2FA(body, x_ua_appKey).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(Unicauth.Create2FAResponse);
      ...
      describe('expireUserSession', function() {
        it('should call expireUserSession successfully', function(done) {
          // TODO: uncomment, update parameter values for expireUserSession call and complete the assertions
          /*

          instance.expireUserSession(body, x_ua_appKey).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(Unicauth.ExpireUserSessionResponse);
      ...
      describe('getSession', function() {
        it('should call getSession successfully', function(done) {
          // TODO: uncomment, update parameter values for getSession call and complete the assertions
          /*

          instance.getSession(x_ua_appKey, s, signature).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(Unicauth.GetSessionResponse);
      ...
      describe('getUserSession', function() {
        it('should call getUserSession successfully', function(done) {
          // TODO: uncomment, update parameter values for getUserSession call and complete the assertions
          /*

          instance.getUserSession(x_ua_appKey, sessionID, userID, signature).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(Unicauth.GetUserSessionResponse);
